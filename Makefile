...
all: rand-test vec-test-01 vec-test-02 vec-test-03 vec-test-04 string-hash-test-01 string-hash-test-02 string-hash-test-03 hash-test-01 hash-test-02 hash-test-03 hash-test-04 hash-test-05 two-vec-test-01 hashpar-test-01 hashpar-test-02 hashpar-test-03 hashpar-test-04
opt: CXXFLAGS += -O3
opt: LDFLAGS += -O3
opt: rand-test vec-test-01 vec-test-02 vec-test-03 vec-test-04 string-hash-test-01 string-hash-test-02 string-hash-test-03 hash-test-01 hash-test-02 hash-test-03 hash-test-04 hash-test-05 two-vec-test-01 hashpar-test-01 hashpar-test-02 hashpar-test-03 hashpar-test-04
...
hashpar-test-04: hashpar-test-04.cc Snap.o hashpar.o
	g++ -o hashpar-test-04 hashpar-test-04.cc Snap.o hashpar.o -I$(GLIB) -I$(SNAP) -I$(HASHPARLIB) $(LDFLAGS)
Snap.o: 
