...
all: rand-test vec-test-01 vec-test-02 string-hash-test-01 string-hash-test-02 string-hash-test-03 hash-test-01 hash-test-02 hash-test-03 hash-test-04 hash-test-05 two-vec-test-01
opt: CXXFLAGS += -O3
opt: LDFLAGS += -O3
opt: rand-test vec-test-01 vec-test-02 string-hash-test-01 string-hash-test-02 string-hash-test-03 hash-test-01 hash-test-02 hash-test-03 hash-test-04 hash-test-05 two-vec-test-01
