/*
 * This program is a version of vec_seq.cc that performs
 * multithreaded sequential access with a gap of 10000000
 * on a vector of size 10000000000.
 * The program has two arguments: the number of operations
 * each thread performs and the thread count
 */
